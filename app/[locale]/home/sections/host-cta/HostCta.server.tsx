...
export function HostCtaSection({ locale }: Props) {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div className="bg-gradient-to-br from-nexa-ink to-nexa-ink-2 rounded-2xl sm:rounded-[32px] p-8 sm:p-12 md:p-16 lg:p-20 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-center">
          <div>
            ...
            <p className="text-white/65 max-w-[500px] mb-6">{t("home.hostCta.subtitle")}</p>
            <div className="flex flex-col gap-2.5 mt-6">
              {bulletKeys.map((key) => (
                <div key={key} className="flex items-center gap-2.5 text-white/80 text-sm">
