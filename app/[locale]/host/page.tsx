...
export default function HostPage() {
  ...
  if (statusChecked && isApproved) {
    return (
      <>
        <NavBar />
        <main className="nexa-guest-main min-h-screen flex items-center justify-center">
          <AppLoader />
        </main>
      </>
    );
  ...
  return (
    <>
      <NavBar />
      <main className="nexa-guest-main min-h-screen grid grid-cols-1 lg:grid-cols-[340px_1fr]">
