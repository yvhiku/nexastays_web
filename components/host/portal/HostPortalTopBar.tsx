...
export function HostPortalTopBar({ onOpenDrawer, drawerOpen = false }: Props) {
  ...
  return (
    <header className="host-portal-top-bar sticky top-0 z-layer-header flex w-full items-center justify-between border-b border-[color:var(--host-border)] bg-[color:var(--host-background)] px-4 pb-3 pt-[calc(0.75rem+env(safe-area-inset-top,0px))] md:px-8">
