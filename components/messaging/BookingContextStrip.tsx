...
export function BookingContextStrip({
  ...
  return (
    <div className="mx-3 mb-3 flex min-h-12 items-center gap-3 rounded-2xl border border-nexa-primary/15 bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(253,240,243,0.88))] px-4 py-2.5 shadow-[0_8px_24px_rgba(135,60,91,0.09)] backdrop-blur-lg">
      ...
      {bookingId ? (
        <button
          ...
          className="hidden min-h-10 items-center gap-1.5 rounded-full bg-[linear-gradient(135deg,#f4809a,#e8507a_55%,#c93a62)] px-4 text-xs font-semibold text-white shadow-[0_6px_16px_rgba(232,80,122,0.24)] transition-[box-shadow,transform] hover:-translate-y-0.5 hover:shadow-[0_9px_22px_rgba(232,80,122,0.30)] active:translate-y-0 active:scale-[0.98] motion-reduce:transition-none sm:inline-flex"
        >
      ...
      <button
        ...
        className="inline-flex min-h-10 items-center gap-1.5 rounded-full border border-nexa-primary/20 bg-white/75 px-3 text-xs font-semibold text-nexa-primary shadow-sm transition-[background-color,border-color,box-shadow,transform] hover:-translate-y-0.5 hover:border-nexa-primary/35 hover:bg-white hover:shadow-nexa-sm active:translate-y-0 motion-reduce:transition-none"
